            ...
            <aside class="sidebar">
                <div class="sidebar-box" style="background: #161b22; border: 1px solid #30363d; border-radius: 12px; padding: 25px; position: sticky; top: 20px;">
                    ...
                    <div class="sidebar-actions">
                        @auth
                            @if($evento->id_usuario !== Auth::id()) {{-- Si no es el organizador --}}

                            @if($evento->usuarios->contains(Auth::id()))
                            {{-- Formulario para DESUNIRSE --}}
                            ...
                            @else
                                <span class="badge badge-info">Eres el organizador de este evento</span>
                            @endif
                            @else
                                <a href="{{ route('login') }}" class="btn btn-secondary">Inicia sesión para unirte</a>
                        @endauth
                    </div>
                </div>
            </aside>
